...
const categories = [
  ...
  { id: "pizza", name: "Pizzas", items: [["Margherita Pizza", 6.5, "Pizza sauce and mozzarella cheese."], ["Vegetarian Pizza", 8.0, "Onions, peppers, mushroom, sweetcorn and tomatoes."], ["Donner Double Pizza", 8.95, "Double portion of donner meat and mozzarella."], ["Pepperoni Passion Pizza", 8.95, "Pepperoni with every bite."], ["Spicy Chicken Pizza", 8.95, "Spicy marinated chicken with peppers."], ["Sweet and Spicy Pizza", 8.95, "Spicy chicken and pineapple."], ["Chicken Pakora Pizza", 9.0, "Chicken pakora pieces on a spiced base."], ["Hawaiian Pizza", 9.5, "Ham and pineapple."], ["Meatball Marinara Pizza", 9.5, "Meatballs in rich marinara sauce."], ["Pollo Pizza", 9.5, "Chicken and sweetcorn."], ["Tornado Pizza", 9.5, "Spicy chicken and spicy pepperoni."], ["Turkish Delight Pizza", 9.5, "Donner meat, spiced onions and chilli base."], ["Four Seasons Pizza", 9.5, "Chicken, mixed peppers, mushrooms and onion."], ["Asian Style Pizza", 9.95, "Chicken tikka, onions, peppers, hot spices and herbs."], ["Four Nations Pizza", 9.95, "Chicken tikka, donner meat, ham and pepperoni."]] },
